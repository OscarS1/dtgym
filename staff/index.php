...
<head>
        <title>DT GYM</title><meta charset="UTF-8" />
        ...
        <div id="loginbox">            
            ...
            <div class="control-group normal_text"> <h3><img src="img/icontest3.png" alt="Logo" /></h3></div>
                ...
                <div class="form-actions center">
                    ...
                    <button type="submit" class="btn btn-block btn-large btn-warning" title="Log In" name="login" value="Admin Login">Inicio de sesión del personal</button>
                </div>
            </form>
            <?php
            ...
            <a href="../index.php"><h6>Inicio administrador</h6></a>
            </div>

            <div class="pull-right">
            <a href="../customer"><h6>Inicio cliente</h6></a>
            </div>
